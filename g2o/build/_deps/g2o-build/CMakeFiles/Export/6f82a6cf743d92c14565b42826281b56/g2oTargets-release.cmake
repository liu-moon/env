...
list(APPEND _cmake_import_check_files_for_g2o::freeglut_minimal "/usr/local/lib/libg2o_ext_freeglut_minimal.so" )
...
set_target_properties(g2o::stuff PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "Eigen3::Eigen;rt"
...
list(APPEND _cmake_import_check_files_for_g2o::stuff "/usr/local/lib/libg2o_stuff.so" )
...
set_target_properties(g2o::opengl_helper PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "OpenGL::GL;OpenGL::GLU;Eigen3::Eigen"
...
list(APPEND _cmake_import_check_files_for_g2o::opengl_helper "/usr/local/lib/libg2o_opengl_helper.so" )
...
set_target_properties(g2o::core PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "g2o::stuff;Eigen3::Eigen"
...
list(APPEND _cmake_import_check_files_for_g2o::core "/usr/local/lib/libg2o_core.so" )
...
list(APPEND _cmake_import_check_files_for_g2o::g2o_cli_library "/usr/local/lib/libg2o_cli.so" )
...
list(APPEND _cmake_import_check_files_for_g2o::g2o_cli_application "/usr/local/bin/g2o" )
...
list(APPEND _cmake_import_check_files_for_g2o::g2o_hierarchical_library "/usr/local/lib/libg2o_hierarchical.so" )
...
list(APPEND _cmake_import_check_files_for_g2o::g2o_simulator_library "/usr/local/lib/libg2o_simulator.so" )
...
list(APPEND _cmake_import_check_files_for_g2o::g2o_simulator2d_application "/usr/local/bin/g2o_simulator2d" )
...
list(APPEND _cmake_import_check_files_for_g2o::g2o_simulator3d_application "/usr/local/bin/g2o_simulator3d" )
...
list(APPEND _cmake_import_check_files_for_g2o::g2o_anonymize_observations_application "/usr/local/bin/g2o_anonymize_observations" )
...
set_target_properties(g2o::g2o_viewer PROPERTIES
  IMPORTED_LOCATION_RELEASE "/usr/local/bin/g2o_viewer"
  )

list(APPEND _cmake_import_check_targets g2o::g2o_viewer )
list(APPEND _cmake_import_check_files_for_g2o::g2o_viewer "/usr/local/bin/g2o_viewer" )
...
set_target_properties(g2o::viewer_library PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "/usr/local/lib/libg2o_viewer.so"
  IMPORTED_SONAME_RELEASE "libg2o_viewer.so"
  )

list(APPEND _cmake_import_check_targets g2o::viewer_library )
list(APPEND _cmake_import_check_files_for_g2o::viewer_library "/usr/local/lib/libg2o_viewer.so" )
...
list(APPEND _cmake_import_check_files_for_g2o::types_data "/usr/local/lib/libg2o_types_data.so" )
...
list(APPEND _cmake_import_check_files_for_g2o::types_slam2d "/usr/local/lib/libg2o_types_slam2d.so" )
...
list(APPEND _cmake_import_check_files_for_g2o::types_slam3d "/usr/local/lib/libg2o_types_slam3d.so" )
...
list(APPEND _cmake_import_check_files_for_g2o::types_sba "/usr/local/lib/libg2o_types_sba.so" )
...
list(APPEND _cmake_import_check_files_for_g2o::types_sim3 "/usr/local/lib/libg2o_types_sim3.so" )
...
list(APPEND _cmake_import_check_files_for_g2o::types_icp "/usr/local/lib/libg2o_types_icp.so" )
...
list(APPEND _cmake_import_check_files_for_g2o::types_sclam2d "/usr/local/lib/libg2o_types_sclam2d.so" )
...
list(APPEND _cmake_import_check_files_for_g2o::types_slam2d_addons "/usr/local/lib/libg2o_types_slam2d_addons.so" )
...
list(APPEND _cmake_import_check_files_for_g2o::types_slam3d_addons "/usr/local/lib/libg2o_types_slam3d_addons.so" )
...
list(APPEND _cmake_import_check_files_for_g2o::solver_pcg "/usr/local/lib/libg2o_solver_pcg.so" )
...
list(APPEND _cmake_import_check_files_for_g2o::solver_dense "/usr/local/lib/libg2o_solver_dense.so" )
...
list(APPEND _cmake_import_check_files_for_g2o::solver_structure_only "/usr/local/lib/libg2o_solver_structure_only.so" )
...
list(APPEND _cmake_import_check_files_for_g2o::solver_csparse "/usr/local/lib/libg2o_solver_csparse.so" )
...
set_target_properties(g2o::csparse_extension PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "/usr/lib/x86_64-linux-gnu/libcxsparse.so;Eigen3::Eigen"
...
list(APPEND _cmake_import_check_files_for_g2o::csparse_extension "/usr/local/lib/libg2o_csparse_extension.so" )
...
list(APPEND _cmake_import_check_files_for_g2o::solver_slam2d_linear "/usr/local/lib/libg2o_solver_slam2d_linear.so" )
...
list(APPEND _cmake_import_check_files_for_g2o::solver_cholmod "/usr/local/lib/libg2o_solver_cholmod.so" )
...
list(APPEND _cmake_import_check_files_for_g2o::solver_eigen "/usr/local/lib/libg2o_solver_eigen.so" )
